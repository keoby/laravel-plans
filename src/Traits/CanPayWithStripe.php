...
trait CanPayWithStripe
{
     ...
     * @return Stripe
     */
    public function initiateStripeAPI(): Stripe
    {
    ...
    public function chargeForLastDueSubscription($callback = null): bool|PlanSubscriptionModel
    {
        ...
        if (! is_callable($callback)) {
            try {
                ...
                event(new \Keoby\LaravelPlans\Events\Stripe\DueSubscriptionChargeSuccess($this, $lastDueSubscription, $stripeCharge));
            } catch (\Exception $exception) {
                event(new \Keoby\LaravelPlans\Events\Stripe\DueSubscriptionChargeFailed($this, $lastDueSubscription, $exception));
